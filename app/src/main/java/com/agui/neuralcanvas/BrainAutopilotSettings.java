...
public class BrainAutopilotSettings {
    ...
    public String getAutopilotInstruction() { String v = autopilotInstruction == null ? "" : autopilotInstruction.trim(); return v.isEmpty() ? "请作为我的第二大脑，自动分析图谱，优先补执行闭环、学习闭环、决策证据和关键连接。保守修改，尽量少但高价值。" : v; }
