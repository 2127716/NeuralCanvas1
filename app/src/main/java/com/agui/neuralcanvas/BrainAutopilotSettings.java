...
public class BrainAutopilotSettings {
    ...
    public String getAssistantScope() {
        String v = assistantScope == null ? "relevant" : assistantScope.trim().toLowerCase();
        return "full".equals(v) ? "full" : "relevant";
    }
    ...
    public String getPreferredAutopilotAgent() {
        ...
        if ("execution".equals(v) || "decision".equals(v) || "learning".equals(v) || "network".equals(v) || "general".equals(v)) {
            return v;
        }
        return "auto";
    }
    ...
    public String getAutopilotInstruction() {
        ...
        return v.isEmpty()
                ? "请作为我的第二大脑，自动分析图谱，优先补执行闭环、学习闭环、决策证据和关键连接。保守修改，尽量少但高价值。"
                : v;
    }
